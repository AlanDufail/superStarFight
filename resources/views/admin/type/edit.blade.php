            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                ...
                <div class="flex flex-row p-2 bg-slate-100 grid-cols-2">
                    <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10 basis-1/2">
                        <form method="POST" action="{{ route('admin.type.edit', $type->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="sm:col-span-6">
                                <label for="name" class="block text-sm font-medium text-gray-700"> Type </label>
                                <div class="mt-1">
                                    <input type="text" id="name" name="name" value="{{ $type->nom }}"
                            ...
                            <div class="sm:col-span-6">
                                <label for="name" class="block text-sm font-medium text-gray-700"> Faible contre </label>
                                <div class="mt-1">
                                    <input type="text" id="name" name="name" value="{{ $type->faibleContre }}"
                                        class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                @error('name')
                                    <span class="text-red-400 text-sm">{{ $message }}</span>
                            ...
                            <div class="sm:col-span-6">
                                <label for="name" class="block text-sm font-medium text-gray-700"> Resistant contre</label>
                                <div class="mt-1">
                                    <input type="text" id="name" name="name" value="{{ $type->resistantContre }}"
                                        class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                @error('name')
                                    <span class="text-red-400 text-sm">{{ $message }}</span>
